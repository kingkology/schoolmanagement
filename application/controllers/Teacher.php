    ...
    function marks($exam_id = '', $class_id = '', $subject_id = '')
    {
        ...
        if ($this->input->post('operation') == 'update') {
            ...
            foreach($students as $row) {
                ...
                $data['class_mark'] = $this->input->post('class_mark' . $row['student_id']);
                $data['final_score'] = ($this->input->post('class_mark' . $row['student_id'])) + ($this->input->post('mark_obtained_' . $row['student_id']))  ;
