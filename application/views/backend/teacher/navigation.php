<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        ?> ">
            ...
            <ul>
                <!-- STUDENT ADMISSION -->
                <li class="<?php if ($page_name == 'student_add') echo 'active'; ?> " hidden>
...
<?php endforeach; ?>
		...
		<!-- STUDY MATERIAL -->
        <li class="<?php if ($page_name == 'study_material') echo 'active'; ?> " hidden>
...
?> ">
        ...
        <!-- LIBRARY -->
        <li class="<?php if ($page_name == 'book') echo 'active'; ?> " hidden>
        ...
        <!-- TRANSPORT -->
        <li class="<?php if ($page_name == 'transport') echo 'active'; ?> " hidden>
