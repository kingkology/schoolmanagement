<div class="row">
                ...
                <table class="table table-bordered" >
                    <thead>class_mark
                        <tr>
                            ...
                            <td><?php echo get_phrase('class_mark');?>(out of 50)</td>
                            <td><?php echo get_phrase('exam_mark');?>(out of 50)</td>
                            <td type="hidden" hidden><?php echo get_phrase('comment');?></td>
                        </tr>
                    </thead>
                    <tbody>
 ...
 <td>
                                     <input type="number" value="<?php echo $row2['class_mark'];?>" name="class_mark_<?php echo $row['student_id'];?>" class="form-control" >
