    ...
    <ul id="main-menu" class="">
        ...
        ?> ">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'student_bulk_add') echo 'active'; ?> " hidden>
        ...
        ?> ">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'exam_marks_sms') echo 'active'; ?> " hidden>
       ...
       <!-- NOTICEBOARD -->
        ...
        ?> ">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'sms_settings') echo 'active'; ?> " hidden>
