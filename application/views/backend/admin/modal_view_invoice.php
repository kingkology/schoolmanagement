...
?>
<center>
    <a onClick="PrintElem()" class="btn btn-default btn-icon icon-left hidden-print pull-right" >
        Print Invoice
...
var DocumentContainer = document.getElementById('invoice_print');
var WindowObject = window.open("", "PrintWindow",
"top=50,toolbars=no,scrollbars=yes,status=no,resizable=yes");


WindowObject.document.write('<link rel="stylesheet" href="assets/css/neon-theme.css" type="text/css" />');
WindowObject.document.write('<link rel="stylesheet" href="assets/js/datatables/responsive/css/datatables.responsive.css" type="text/css" />')
